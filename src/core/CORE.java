...
public interface CORE extends Serializable 
{
 ...
 // ***************** Players Team************************   
     ...
     **/
    boolean isInPlayersTeam(String nme);
