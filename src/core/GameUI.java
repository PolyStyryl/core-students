        ...
        try
        {
            ...
            while (choice != 0)
            {
                ...
                else if (choice == 3)
                {
                    ...
                    System.out.println(tr.getChampionDetails(nme));
                } 
                else if (choice == 4)
                {   
                    System.out.println("Enter Champion name");
                    ...
                    switch(result){
                        case 0:
                            System.out.println("\nChampion successfully entered");
                            break;
                        case 1:
                            System.out.println("\nChampion is not in reserve");
                            break;
                        case 2:
                            System.out.println("\nNot enough in the treasury to afford champion");
                            break;
                        case -1:
                            System.out.println("\nCould not find champion");
                            break;
                    }
                ...
                {
                    System.out.println("Enter the name of the champion to retire");
                    String nme = myIn.nextLine();
                    result = tr.retireChampion(nme);

                    switch(result){
                        case 0:
                            System.out.println("\nChampion successfully retired");
                            break;
                        case 1:
                            System.out.println("\nThis champion cannot be retired as they're dead");
                            break;
                        case 2:
                            System.out.println("\nThis champion cannot be retired as they're not in your team");
                            break;
                        case -1:
                            System.out.println("\nChampion cannot be found");
                            break;
                    }
                }  
                else if (choice==7)
                {
                 ...
                 else if (choice == 8) // Task 4.4 only
                 {
                     ...
                     tr.saveGame("savedData.txt");
                 }
                 else if (choice == 9) // Task 4.4 only
                 {
                     System.out.println("Restore from file");
                     tr = (Tournament) tr.loadGame("savedData.txt");
                     System.out.println(tr.toString());
                 }
            }     
        }
